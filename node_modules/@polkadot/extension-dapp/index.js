...
function web3Enable(originName) {
  ...
  exports.web3EnablePromise = web3EnablePromise = (0, _util.documentReadyPromise)(() => getWindowExtensions(originName).then(values => values.filter(value => !!value[1]).map(([info, ext]) => {
